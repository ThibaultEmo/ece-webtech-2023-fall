...
> Note! This instruction will be updated slightly in the coming days.

## Deadline

*DATE TO BE SET*. You must push your latest commit before the midnight of this date. 
...
* The repository must be structured like this:
  ...
  /
    ...
    ...
  ```
  Additional root-level files and folders are possible.
* You must stricly respect the format of the root-level `README.md` provided in [this template](./project-template/README.md).     
  The `README.md` file must include the tasks you did with your comments and self-evaluation:
...
> Note! The project template will be provided.
...
> Note! Certain tasks will be changed in the coming days.
